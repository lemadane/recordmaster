package io.lemadane.recordmaster.processor;
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        for (Element elem : roundEnv.getRootElements()) {
            if (elem.getKind() == ElementKind.RECORD) {
                ...
                // Check if it implements io.lemadane.recordmaster.Record
                for (TypeMirror interfaceType : typeElement.getInterfaces()) {
                    if (interfaceType.toString().equals("io.lemadane.recordmaster.Record")) {
                        isRecordMaster = true;
                        break;
                    }
                }
                ...
                if (typeElement.getAnnotation(io.lemadane.recordmaster.annotations.Table.class) != null) {
                    isRecordMaster = true;
                }
    ...
    private void generateFieldsClass(TypeElement typeElement) {
        ...
        try {
            ...
            try (Writer writer = fileObject.openWriter()) {
                ...
                writer.write("import io.lemadane.recordmaster.Field;\n\n");
