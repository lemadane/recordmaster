...
import io.lemadane.recordmaster.core.TableState;
import io.lemadane.recordmaster.core.IndexMetadata;
...
public final class SqlMigrator {
    ...
    private static void bindValue(PreparedStatement ps, int paramIndex, Object val, Class<?> type, SqlDialect dialect) throws Exception {
        ...
        if (type == String.class) {
            ...
            String json = io.lemadane.recordmaster.core.SimpleJson.serialize(val);
